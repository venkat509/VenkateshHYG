...
declare module "@salesforce/schema/Task.compliancequest__CQ_Task_Code__c" {
  const compliancequest__CQ_Task_Code__c:string;
  export default compliancequest__CQ_Task_Code__c;
}
declare module "@salesforce/schema/Task.compliancequest__Child_What_Id__c" {
  const compliancequest__Child_What_Id__c:string;
  export default compliancequest__Child_What_Id__c;
}
declare module "@salesforce/schema/Task.compliancequest__SQX_Audit__r" {
  const compliancequest__SQX_Audit__r:any;
  export default compliancequest__SQX_Audit__r;
}
declare module "@salesforce/schema/Task.compliancequest__SQX_Audit__c" {
