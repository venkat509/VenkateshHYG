...
declare module "@salesforce/schema/Account.compliancequest__Account_Classification__c" {
  const compliancequest__Account_Classification__c:string;
  export default compliancequest__Account_Classification__c;
}
declare module "@salesforce/schema/Account.compliancequest__Active__c" {
  const compliancequest__Active__c:string;
  export default compliancequest__Active__c;
}
declare module "@salesforce/schema/Account.compliancequest__Approval_Status__c" {
  const compliancequest__Approval_Status__c:string;
  export default compliancequest__Approval_Status__c;
}
declare module "@salesforce/schema/Account.compliancequest__CQ_Owner__r" {
  const compliancequest__CQ_Owner__r:any;
  export default compliancequest__CQ_Owner__r;
}
declare module "@salesforce/schema/Account.compliancequest__CQ_Owner__c" {
  const compliancequest__CQ_Owner__c:any;
  export default compliancequest__CQ_Owner__c;
}
declare module "@salesforce/schema/Account.compliancequest__Expired_Supplier_Document__c" {
  const compliancequest__Expired_Supplier_Document__c:boolean;
  export default compliancequest__Expired_Supplier_Document__c;
}
declare module "@salesforce/schema/Account.compliancequest__Last_Audit_Date__c" {
  const compliancequest__Last_Audit_Date__c:any;
  export default compliancequest__Last_Audit_Date__c;
}
declare module "@salesforce/schema/Account.compliancequest__Next_Audit_Date__c" {
  const compliancequest__Next_Audit_Date__c:any;
  export default compliancequest__Next_Audit_Date__c;
}
declare module "@salesforce/schema/Account.compliancequest__Reason_For_Change__c" {
  const compliancequest__Reason_For_Change__c:string;
  export default compliancequest__Reason_For_Change__c;
}
declare module "@salesforce/schema/Account.compliancequest__SQX_Supplier_Escalation__r" {
  const compliancequest__SQX_Supplier_Escalation__r:any;
  export default compliancequest__SQX_Supplier_Escalation__r;
}
declare module "@salesforce/schema/Account.compliancequest__SQX_Supplier_Escalation__c" {
  const compliancequest__SQX_Supplier_Escalation__c:any;
  export default compliancequest__SQX_Supplier_Escalation__c;
}
declare module "@salesforce/schema/Account.compliancequest__Status__c" {
  const compliancequest__Status__c:string;
  export default compliancequest__Status__c;
}
declare module "@salesforce/schema/Account.compliancequest__Supplier_Escalation_Level__c" {
  const compliancequest__Supplier_Escalation_Level__c:string;
  export default compliancequest__Supplier_Escalation_Level__c;
}
declare module "@salesforce/schema/Account.compliancequest__Supplier_Type__c" {
  const compliancequest__Supplier_Type__c:string;
  export default compliancequest__Supplier_Type__c;
}
declare module "@salesforce/schema/Account.compliancequest__Supplier_Risk_Level__c" {
  const compliancequest__Supplier_Risk_Level__c:number;
  export default compliancequest__Supplier_Risk_Level__c;
}
